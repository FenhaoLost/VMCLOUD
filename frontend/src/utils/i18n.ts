const exact: Record<string, string> = {
  ...
  'SSL 设置已保存，重启 eyvescloud 服务后生效。': 'SSL settings saved. Restart the eyvescloud service to apply them.',
  ...
  '默认盘': 'Default Disk',
  '设为': 'Set as',
  'EYVESCLOUD 其他': 'Other EYVESCLOUD Data',
  '非 EYVESCLOUD': 'Non-EYVESCLOUD Data',
  '可用空间': 'Free Space',
